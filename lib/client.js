  ...
  return createElement('div', { className: 'dsh-me-user-row' }, [
    ...
    referenceText !== null && config.showOriginalInput
      && createElement('details', { key: 'reference', className: 'dsh-me-reference' }, [
        createElement('summary', { title: t('marker.referenceHint') }, t('marker.originalLabel')),
...
.dsh-me-reference summary{color:var(--dsw-alias-label-caption);cursor:pointer;user-select:none;font-size:12px;line-height:22px;list-style:none;display:inline-flex;align-items:center;gap:6px}
